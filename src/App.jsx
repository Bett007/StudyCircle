...
function App() {
  ...
  useEffect(() => {
    const fetchQuotes = async () => {
      try {
        const res = await fetch('https://api.quotable.io/quotes?limit=5&tags=motivational|inspirational|success|student');
        ...
        setQuotes([
          ...
          { content: "Discipline today → Freedom tomorrow.", author: "Unknown" },
          { content: "One hour of focus can change everything.", author: "Unknown" },
          { content: "Keep going. Someone out there is proud of you.", author: "Anonymous" }
        ]);
      }
    };
    fetchQuotes();
